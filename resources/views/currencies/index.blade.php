                                ...
                                <table id="datatable" class="table table-striped dt-responsive nowrap text-center" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" __currency="{{ $res->currency }}" __action="{{ route('currencies.update', $res->id) }}" class="btn btn-warning waves-effect waves-light btn-sm edit"><i class="typcn typcn-edit"></i> Edit</a>
                                                <a href="#" data-uri="{{ route('currencies.destroy', $res->id) }}" class="btn btn-primary waves-effect waves-light btn-sm" data-toggle="modal" data-target="#modalDestroy"><i class="typcn typcn-trash"></i> Delete</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
            ...
            <form method="POST" action="{{ route('currencies.store') }}" class="needs-validation" novalidate="">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <input type="text" class="form-control" name="currency" required data-parsley-type="currency" placeholder="Currency">
                    </div>
                </div>
